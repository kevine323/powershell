...
$subscriptionID='f45c7541-6906-461d-9a4c-8046388d2a2d'   # the ID  of subscription name you will use  
#$locationName = '<a data center location>'  # the data center region you will use  
$storageAccountName= 'rydertmwnonprodbak' # the storage account name you will create or use  
$containerName= $prefixName + 'azrvtryddsql1'  # the storage container name to which you will attach the SAS policy with its SAS token  
$policyName = 'BackupPolicy_Restore' # the name of the SAS policy 

# Set a variable for the name of the resource group you will create or use  
$resourceGroupName='rgEUS_TMW'   
